...
<div class="container" style="padding-top:0px;">		
		<div class="panel panel-danger" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;">
			<div class="panel-heading" style="background-color:#f2dede !important; text-align: center;font-size: 35px;padding: 20px;">Advertencia</div>
			<div class="panel-body">
			<div style="text-align:center;font-size:40px;"><i class="fa fa-exclamation-circle"></i> P&aacute;gina no disponible</div>
